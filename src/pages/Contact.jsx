...
export default function Contact() {
  ...
  return (
    <>
      ...
      {/* ================= CONTACT PAGE ================= */}
      <section className="bg-[#FFF8F1] min-h-screen pt-28 pb-24 px-6">

        {/* TITLE */}
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-serif font-bold text-[#8B2E1F]">
            Contact Us
          </h1>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12">
          ...
          <div className="bg-white rounded-3xl shadow-xl p-10 space-y-8">
            ...
            <h2 className="text-3xl font-bold text-[#8B2E1F]">
              Get in Touch
            </h2>
  ...
  />
          ...
          <div className="bg-white rounded-3xl shadow-xl p-10">
            ...
            <h2 className="text-3xl font-bold text-[#8B2E1F] mb-6">
              Send a Message
            </h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full border rounded-xl px-4 py-3 focus:ring-2 focus:ring-[#8B2E1F] outline-none"
                />
              </div>
