    ...
    <div className="about-page pt-24 bg-[#FFF8F1] overflow-x-hidden">
      ...
      <section className="history-section max-w-6xl mx-auto my-16 flex flex-col md:flex-row gap-12 px-4 md:px-0 animate-on-scroll">
        <div className="history-left md:w-1/2">
          <h2 className="text-3xl md:text-4xl font-bold text-[#8B2E1F] mb-4">इतिहास — 1934 पासून</h2>
          ...
          <h3 className="text-2xl md:text-3xl font-semibold text-[#8B2E1F] mb-2">सध्याचे व्यवस्थापन</h3>
          ...
          {achievements.map((a, i) => (
            ...
            >
              ...
              <div className="achievement-text md:w-1/2">
                <h3 className="text-2xl md:text-3xl font-semibold text-[#8B2E1F] mb-2">{a.title}</h3>
                <p className="text-[#8B2E1F]/90 text-base md:text-lg">{a.text}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="media-section max-w-7xl mx-auto my-20 px-4 md:px-0 animate-on-scroll">
        <div className="text-center mb-10">
          <h2 className="text-4xl md:text-5xl font-extrabold text-[#8B2E1F] mb-3 animate-pulse">
            🌻 काही वृत्तपत्रे 🌻
          </h2>
          <p className="text-[#8B2E1F]/70 text-lg md:text-xl">
            टाइम्स ऑफ इंडिया • हिंदी जागरण • दैनिक ऐक्य • दैनिक सकाळ • दैनिक पुढारी
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {[newsPaper, media1, media2, media3, news2].map((imgSrc, index) => (
            <div
              key={index}
              className="relative group overflow-hidden rounded-3xl shadow-xl transform transition-all duration-500 hover:scale-105 hover:shadow-2xl"
            >
              <img
                src={imgSrc}
                alt={`Media ${index + 1}`}
        ...
        <div className="relative flex flex-col md:flex-row items-center justify-between gap-8 p-10 md:p-16 rounded-3xl bg-[#F5E6DC]/90 backdrop-blur-sm shadow-lg transform transition duration-500 hover:scale-105">
          <div className="cta-left md:w-2/3">
            <h3 className="text-3xl md:text-4xl font-extrabold text-[#8B2E1F] mb-4 flex items-center gap-2">
              <span>🌸</span> दुर्गा खानावळ — चला अनुभव घेऊया
            </h3>
